...
console.log(`La moyenne d'âge des ${chiens.length} chiens est de : ${calculerMoyenAge(chiens)} ans`);
console.log("----------------------------");
afficherListeAnimal(chats);
console.log(`La moyenne d'âge des ${chats.length} chats est de : ${calculerMoyenAge(chats)} ans`);
console.log("----------------------------");
